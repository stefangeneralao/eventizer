...
// Test disabled atm (TypeError: Cannot read property 'value' of undefined)
  xit('should contain className FormWrapper', () => {
...
// Test disabled atm (TypeError: Cannot read property 'value' of undefined)
  xit('should have className RegisterCard', () => {
    const wrapper = shallow(
      <RegisterCard
        store={data}
        />
      );
    expect(wrapper.hasClass("RegisterCard"));
  });
});
