...
// Testsuite for src/app/main/routes/registerform/index.js
...
describe('<RegisterForm />', () => {
  it('should have className RegisterForm', () => {
    const wrapper = shallow(
      <RegisterForm
        store={data}
        />
      );
    expect(wrapper.hasClass("RegisterForm"));
  });

  it('should contain RegisterCard-child', () => {
    const wrapper = shallow(
      <RegisterForm
        store={data}
        />
      );
    expect(wrapper.find(RegisterCard)).toHaveLength(1);
  });
});
