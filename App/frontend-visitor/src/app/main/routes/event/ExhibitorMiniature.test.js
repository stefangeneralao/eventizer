...
import ExhibitorMiniature from './ExhibitorMiniature.js';
import { Link } from 'react-router-dom';

// Testsuite for ExhibitorMiniature.js
...
describe('<ExhibitorMiniature />', () => {
  it('should have className ExhibitorMiniature', () => {
    const wrapper = shallow(
      <ExhibitorMiniature
      store={data}
      />
    );
    expect(wrapper.hasClass("ExhibitorMiniature"));
  });

  it('should contain a Link-child', () => {
    const wrapper = shallow(
      <ExhibitorMiniature
        store={data}
        />
