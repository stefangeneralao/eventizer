...
// Testsuite for ImageComponent.js
...
describe('<ImageComponent />', () => {
  it('should have className ImageComponent', () => {
    const wrapper = shallow(<ImageComponent cardsData={data.dates} />);
    expect(wrapper.hasClass("ImageComponent"));
  });

  it('should contains ImageCarousel-child', () => {
